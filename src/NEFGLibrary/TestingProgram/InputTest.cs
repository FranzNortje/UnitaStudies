...
namespace TestingProgram {
  ...
  public class InputTest {
    ...
    [TestMethod]
    public void CalculateInvestmentAfterFinancialAdviserFeeTest() {
      Assert.AreEqual(4942.50m, BusinessLogic.Calculation.InvestmentAfterFinancialAdviserFee(5000m, 0.01m, 1.15m));
    }
